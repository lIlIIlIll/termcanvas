...
## TERMCANVAS-047 sampling description

The limitation recorded for TERMCANVAS-047 in the frozen first-round status file says that a complete transaction lock protects shared sampler state. That description is inaccurate.
