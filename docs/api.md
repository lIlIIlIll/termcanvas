...
The current production inventory contains 398 top-level declarations:

| Tier | Top-level declarations | Intended audience |
| --- | ---: | --- |
| STABLE | 212 | Normal application and library use |
| EXPERIMENTAL | 138 | Explicit opt-in; may evolve or be removed before 1.0 |
| INTERNAL | 34 | Runtime/package implementation, not application API |
| TEST_ONLY | 14 | Repository test and fixture support |

Use the generated inventory for exhaustive membership. Physical location in
`core` does not determine stability.
